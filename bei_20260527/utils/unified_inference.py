...
VLLM_CLIENTS = {
    "client1": AsyncOpenAI(
        api_key=os.getenv("VLLM_CLIENT1_API_KEY", ""),
        base_url=os.getenv("VLLM_CLIENT1_BASE_URL", "http://192.168.1.159:21000/v1"),
    ),
    "client2": AsyncOpenAI(
        api_key=os.getenv("VLLM_CLIENT2_API_KEY", ""),
...
class UnifiedModelInference:
    ...
    def __init__(self):
        ...
        self.answer_knowledge_gen_consist = _load_prompt("task_answer_knowledge_gen_consist.txt")
    ...
    async def _workflow_answer_analysis(self, data: Dict[str, Any], sys_prompt: str, prompt: str, 
        ...
        elif task_name == "answer_correct_gen":
            task_consist = self.answer_correct_gen_consist
        elif task_name == "answer_knowledge_gen":
            task_consist = self.answer_knowledge_gen_consist
