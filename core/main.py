...
from utils.http_request import ModelService,TaskDetailService,ModelCompareResultAdd,CleanDataUpdate,TaskDetailUpdate
# ================= 路径加载 =================
...
# python core/main.py --task answer_knowledge
